Keeps config and related files to quickly setup Linux systems.

Navigate subdirs to see detail. 
All install scripts use Python 3 as interpreter (and thus is a required dependency) to serve the feature of
- Easily parse `meta.json` that stores path info
- Easily navigate path dynamically
